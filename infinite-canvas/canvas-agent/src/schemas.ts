...
export const canvasOpSchema = z.discriminatedUnion('type', [
    z
        ...
        .passthrough(),
    z
        .object({ type: z.literal('update_node'), id: z.string(), patch: recordSchema.optional(), metadata: recordSchema.optional() })
        .passthrough(),
...
export const toolInputSchemas = {
    ...
    canvas_create_image_prompt_flow: z
        .object({ prompt: z.string(), x: z.number().optional(), y: z.number().optional(), autoRun: z.boolean().optional() })
        .merge(generationOptionsSchema),
