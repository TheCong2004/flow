        ...
        <main className='mx-auto flex w-full max-w-6xl flex-1 flex-col px-5 pb-16 pt-8 md:px-10 md:pt-14'>
            <section className='grid min-h-[520px] items-center gap-10 border-b border-zinc-200 pb-12 dark:border-zinc-800 lg:grid-cols-[0.88fr_1.12fr]'>
                ...
                <div className='overflow-hidden rounded-2xl lg:w-[108%] lg:max-w-none'>
                    <img src={previewImages[3].src} alt='无限画布效果图' className='aspect-[16/10] w-full rounded-xl object-cover' />
                </div>
            </section>
            ...
            <section className='mt-14'>
                <div className='flex flex-col gap-2 md:flex-row md:items-end md:justify-between'>
                    <div>
                        <h2 className='text-2xl font-semibold text-zinc-950 dark:text-zinc-50 md:text-3xl'>效果展示</h2>
                    </div>
                    <Link
            ...
            <section className='mx-auto mt-16 w-full max-w-4xl text-center'>
                <h2 className='text-2xl font-semibold text-zinc-950 dark:text-zinc-50 md:text-3xl'>开发贡献者</h2>
                <p className='mt-2 text-sm text-zinc-500 dark:text-zinc-400'>感谢所有为本项目做出贡献的开发者</p>
            ...
            <section className='mx-auto mt-16 w-full max-w-5xl text-center'>
                <h2 className='text-2xl font-semibold text-zinc-950 dark:text-zinc-50 md:text-3xl'>Star History</h2>
                <div className='mt-7 flex justify-center'>
                    <a href={starHistoryUrl} target='_blank' rel='noreferrer noopener' className='block w-full max-w-4xl'>
                        <picture>
                            <source media='(prefers-color-scheme: dark)' srcSet={darkStarHistoryChart} />
                            <source media='(prefers-color-scheme: light)' srcSet={starHistoryChart} />
                            <img
