    ...
    return (
        <ImageSettingsTheme theme={theme}>
            <div className={className} style={{ color: theme.node.text }} onMouseDown={(event) => event.stopPropagation()}>
                {showTitle ? <div className="text-lg font-semibold">Cài đặt âm thanh</div> : null}
                <SettingGroup title="Giọng" color={theme.node.muted}>
                ...
                <SettingGroup title="Định dạng" color={theme.node.muted}>
                    <div className="grid grid-cols-3 gap-2.5">
                ...
                <SettingGroup title="Tốc độ nói" color={theme.node.muted}>
                ...
                <SettingGroup title="Chỉ dẫn giọng đọc" color={theme.node.muted}>
                    <textarea
                        value={config.audioInstructions || ""}
                        placeholder="Ví dụ: tự nhiên, ấm áp, phù hợp làm lời dẫn."
