...
export function InfiniteCanvas({ containerRef, viewport, backgroundMode = "lines", readOnly = false, onViewportChange, onCanvasMouseDown, onCanvasDeselect, onContextMenu, onDrop, children }: InfiniteCanvasProps) {
    ...
    const handlePointerDown = (event: React.PointerEvent<HTMLDivElement>) => {
        ...
        if (!readOnly && event.button === 0 && (event.ctrlKey || event.metaKey) && isBackgroundClick) {
    ...
    return (
        <div
            ...
            data-canvas-readonly={readOnly ? "true" : undefined}
        >
