...
export function ImageSettingsPanel({ config, onConfigChange, theme, showTitle = true, className = "w-[320px] space-y-4 rounded-2xl px-1 py-0.5", maxCount = 15, quickCount = 10 }: ImageSettingsPanelProps) {
    ...
    return (
        <ImageSettingsTheme theme={theme}>
            ...
            >
                {showTitle ? <div className="text-lg font-semibold">Cài đặt ảnh</div> : null}
                <div className="space-y-2.5">
                    <SettingTitle color={theme.node.muted}>Chất lượng</SettingTitle>
                ...
                <div className="space-y-2.5">
                    <div className="flex items-center justify-between gap-3">
                        <SettingTitle color={theme.node.muted}>Kích thước</SettingTitle>
                        <div className="flex items-center gap-2">
                            <span className="text-xs font-medium" style={{ color: theme.node.muted }}>
                                Căn bội số 16
                            </span>
                            <span title="Tự làm tròn lên bội số 16 sau khi nhập" onMouseDown={(event) => event.stopPropagation()}>
                ...
                <div className="space-y-2.5">
                    <SettingTitle color={theme.node.muted}>Tỷ lệ khung hình</SettingTitle>
                    <div className="grid grid-cols-4 gap-2.5">
                ...
                <div className="space-y-2.5">
                    <SettingTitle color={theme.node.muted}>Số ảnh tạo</SettingTitle>
                    <div className="grid grid-cols-4 gap-2.5">
...
export function imageQualityLabel(value: string) {
    return ({ auto: "Tự động", high: "Cao", medium: "Vừa", low: "Thấp" } as Record<string, string>)[value] || value;
}
