    ...
    return (
        ...
        >
            <div className='mb-2 flex items-center justify-between gap-3'>
                <div className='shrink-0 text-sm font-semibold'>Cấu hình tạo</div>
            ...
            <div className='mb-2 flex flex-wrap gap-1.5'>
                ...
                <InputChip label='Video tham chiếu' value={`${inputSummary.videoCount} mục`} style={chipStyle} />
                <InputChip label='Âm thanh tham chiếu' value={`${inputSummary.audioCount} mục`} style={chipStyle} />
                <button
                    type='button'
            ...
            <div
                className={`mb-2 grid min-w-0 cursor-default items-center gap-2 ${
                    mode === 'image' || mode === 'video' || mode === 'audio' ? 'grid-cols-[minmax(0,1fr)_148px]' : 'grid-cols-1'
                }`}
                onMouseDown={(event) => event.stopPropagation()}
            >
                <ModelPicker
