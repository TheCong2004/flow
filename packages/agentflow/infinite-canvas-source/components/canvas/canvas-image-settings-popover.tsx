...
import { imageQualityLabel, ImageSettingsPanel, imageSizeLabel } from '@/components/image-settings-panel'
            ...
            <span ref={buttonRef} className='inline-flex min-w-0'>
                ...
                >
                    <span className='truncate'>
                        {imageQualityLabel(quality)} · {imageSizeLabel(activeSize)} · {count} mảnh
                    </span>
                </Button>
            </span>
            {panel}
