...
import { type AiConfig, defaultConfig, useConfigStore, useEffectiveConfig } from '@/stores/use-config-store'
import { useThemeStore } from '@/stores/use-theme-store'
import { type CanvasGenerationMode, type CanvasNodeData, CanvasNodeType } from '@/types/canvas'

import { type CanvasAudioSettingKey, CanvasAudioSettingsPopover } from './canvas-audio-settings-popover'
        ...
        >
            ...
            <div className='mt-2 flex min-w-0 items-center justify-between gap-2'>
                ...
                <Button
                    ...
                    aria-label={isRunning ? 'Dừng tạo' : 'Tạo'}
                >
...
function promptPlaceholder(mode: CanvasNodeGenerationMode, hasImageContent: boolean, hasTextContent: boolean) {
    if (mode === 'video') return 'Mô tả video muốn tạo…'
    if (mode === 'audio') return 'Mô tả âm thanh muốn tạo…'
    if (mode === 'image') return hasImageContent ? 'Mô tả cách muốn chỉnh sửa ảnh này…' : 'Mô tả ảnh muốn tạo…'
    return hasTextContent ? 'Mô tả cách muốn chỉnh đoạn văn bản này…' : 'Nhập nội dung văn bản muốn tạo…'
}
