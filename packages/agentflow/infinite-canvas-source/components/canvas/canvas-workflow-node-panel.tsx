...
export function CanvasWorkflowNodePanel({
    node,
    readOnly = false,
    canRun = false,
    isRunning = false,
        ...
        >
            <div className='mb-3 flex items-center justify-between gap-2'>
                ...
                <div className='flex items-center gap-1'>
                    ...
                    <button
                        type='button'
                        className='grid size-8 place-items-center rounded-lg opacity-60 transition hover:bg-white/10 hover:opacity-100'
                        onClick={onClose}
                        aria-label='Đóng'
                    >
                        <X className='size-4' />
                ...
                {showRefImages || refIds.length > 0 ? (
                    <div className='space-y-2'>
                        ...
                        {refIds.length ? (
                                    ...
                                    return (
                                        ...
                                        >
                                            {thumb ? (
                                                ...
                                                <div className='grid size-full place-items-center text-[10px] opacity-40'>
                                                    {fileId.slice(0, 8)}
                                                </div>
                                            )}
                                            {!readOnly ? (
                            ...
                            <div
                                className='rounded-xl border border-dashed px-3 py-4 text-center text-xs opacity-50'
                                style={{ borderColor: theme.node.stroke }}
                            >
