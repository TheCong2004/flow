...
export function CanvasWorkflowPalette({ readOnly = false, onAddNode }: CanvasWorkflowPaletteProps) {
    ...
    return (
        ...
        >
            <div
                className='flex items-center gap-2 border-b px-3 py-2 text-xs font-semibold uppercase tracking-wide opacity-70'
            ...
            <div className='flex-1 overflow-y-auto p-1.5'>
                {items.map((item) => (
                    <Button
                        ...
                        className='!h-8 !justify-start !rounded-xl !px-2 !text-left !text-xs'
